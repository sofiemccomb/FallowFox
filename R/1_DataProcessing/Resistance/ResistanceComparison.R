#Compare Resistance Layers Using Pearson's Correlation Test
...
#Pearson Correlation Test between Raster Layers
  ...
  res_2011_stack<-stack(res2011,res2011_eq1, res2011_eq3, res2011_eq5, res2011_c.25, res2011_c4, res2011_c8)
  res_2015_stack<-stack(res2015,res2015_eq1, res2015_eq3, res2015_eq5, res2015_c.25, res2015_c4, res2015_c8)
  res_2017_stack<-stack(res2017,res2017_eq1, res2017_eq3, res2017_eq5, res2017_c.25, res2017_c4, res2017_c8)
...
#Create histograms comparing distribution of values for each raster
  #2011
  pdf(file = "Data/1_DataProcessing/Resistance/Revisions/ResistanceComparison/Resistance_ras_2011_histograms.pdf", width = 11, height = 8.5)
  hist(res_2011_stack, breaks=30)
  dev.off()
  #Create histograms comparing distribution of values for each raster
  #2015
  pdf(file = "Data/1_DataProcessing/Resistance/Revisions/ResistanceComparison/Resistance_ras_2015_histograms.pdf", width = 11, height = 8.5)
  hist(res_2015_stack, breaks=30)
  dev.off()
  #Create histograms comparing distribution of values for each raster
  #2017
  pdf(file = "Data/1_DataProcessing/Resistance/Revisions/ResistanceComparison/Resistance_ras_2017_histograms.pdf", width = 11, height = 8.5)
  hist(res_2017_stack, breaks=30)
  dev.off()
