...
LCP_2012_df<-LCP_2012 %>% dplyr::select(From_Core, To_Core, LCP_Length, Effective_Resistance) %>% dplyr::rename(Length_2012=LCP_Length, EffResistance_2012=Effective_Resistance)
LCP_2013_df<-LCP_2013 %>% dplyr::select(From_Core, To_Core, LCP_Length, Effective_Resistance) %>% dplyr::rename(Length_2013=LCP_Length, EffResistance_2013=Effective_Resistance)
LCP_2014_df<-LCP_2014 %>% dplyr::select(From_Core, To_Core, LCP_Length, Effective_Resistance) %>% dplyr::rename(Length_2014=LCP_Length, EffResistance_2014=Effective_Resistance)
LCP_2015_df<-LCP_2015 %>% dplyr::select(From_Core, To_Core, LCP_Length, Effective_Resistance) %>% dplyr::rename(Length_2015=LCP_Length, EffResistance_2015=Effective_Resistance)
LCP_2016_df<-LCP_2016 %>% dplyr::select(From_Core, To_Core, LCP_Length, Effective_Resistance) %>% dplyr::rename(Length_2016=LCP_Length, EffResistance_2016=Effective_Resistance)
LCP_2017_df<-LCP_2017 %>% dplyr::select(From_Core, To_Core, LCP_Length, Effective_Resistance) %>% dplyr::rename(Length_2017=LCP_Length, EffResistance_2017=Effective_Resistance)
